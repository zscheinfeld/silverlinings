        ...
        <div className={styles.multipleCardsContainer} ref={ref}>
            {cards.map((card, index) => (
                <motion.div
                    ...
                    className={styles.multipleSidenoteInnterContainer}
                >
